...
(defun change-disp-color(num)
  (let ((disps)(default-color)(background)(highlight)(baseline-color))
    (setq disps (list (G-widget "disp1")(G-widget "disp2")(G-widget "disp3")(G-widget "disp4")))
...
(defun change-disp-color-menu()
  (let ((col (resource (G-widget "disp2") :default-color)))
...
(defun create-disp5(dispname)
  (let ((w)(w1)(disp1 t))
    (setq w1 (G-widget dispname))
    (if (equal dispname "disp1")(setq disp1 nil))
    (when (not (G-widget "disp5" :quiet))(require-widget :plotter "disp5"))
    (setq w (G-widget "disp5"))
...
(defun create-main-form()
  (let ((paneL)(paneR)(LR 45)(x 5)(xx 98))
    ...
    (create-subdisp paneR form901 "disp2" nil nil)
    (create-subdisp paneR form901 "disp3" nil nil)
    (create-subdisp paneR form901 "disp4" nil nil);nil control panel
...
(defun create-my-memo-menu3(bar title);dislay
  (let ((menu))      
    ...
    (make-menu menu "for clipboard copy" nil :tear-off
      '("MEG 8 stacks" (create-disp5 "disp1"))
      '("MEG" (create-disp5 "disp2"))
      '("EEG" (create-disp5 "disp3"))
...
(defun initialize-hnsmeg()
  ...
  (pick "meg0")(pick "meg")(pick "meg1")(pick "eeg1")(pick "eeg2")(pick "misc")(pick "meg8")(pick "meg-select")
  ...
  (linklink '("file" "buf" "meg0" "ssp" "band-pass1" "meg" "meg8" "disp1"))
  (linklink '("meg" "meg-select"))
  (linklink '("meg" "meg1" "disp2"))
  (linklink '("buf" "band-pass2" "eeg1" "fsub"))
  (linklink '("band-pass2" "eeg2" "fsub" "disp3"))
  (linklink '("buf" "band-pass3" "misc" "disp4"))
  (set-resource (G-widget "disp1") :ch-label-space -1)
  (set-resource (G-widget "disp1") :move-hook '(sync-view-2 "disp1" "disp2" "disp3" "disp4"))
  (set-resource (G-widget "disp1") :select-hook '(sync-selection "disp1" "disp2" "disp3" "disp4"))
  (set-resource (G-widget "disp2") :move-hook '(sync-view-2 "disp2" "disp1" "disp3" "disp4"))
  (set-resource (G-widget "disp2") :select-hook '(sync-selection "disp2" "disp1" "disp3" "disp4"))
  (set-resource (G-widget "disp3") :move-hook '(sync-view-2 "disp3" "disp1" "disp2" "disp4"))
  (set-resource (G-widget "disp3") :select-hook '(sync-selection "disp3" "disp1" "disp2" "disp4"))
  (set-resource (G-widget "disp4") :move-hook '(sync-view-2 "disp4" "disp1" "disp2" "disp3"))
  (set-resource (G-widget "disp4") :select-hook '(sync-selection "disp4" "disp1" "disp2" "disp3"))
  (set-resource (G-widget "disp1") :length 10)
  (set-resource (G-widget "disp2") :length 10)
  (set-resource (G-widget "disp3") :length 10)
  (set-resource (G-widget "disp4") :length 10)
  (defchs)
  (defchpos)
  ...
  (setq ch (append gra-L-temporal gra-R-temporal gra-L-parietal gra-R-parietal 
                   gra-L-occipital gra-R-occipital gra-L-frontal gra-R-frontal))
  (set-resource (G-widget "meg8") :names ch)  
  (select-megch "menu")
  (select-eegch "menu")
...
(defun my-text-delete(str)
  (let ((str0 (XmTextGetString my-text903))(strm)(str1 "zzz")(str2)(nL))
      ...
      (dotimes (i nL)
        ...
        (if (and (numberp (first x))(> (length x) 4))(progn
          ...
          (if (numberp x4)(progn
            ...
            ;(if (not (equal x4 (fourth y)))(print (list x4 (fourth y))))
            (if (> (length x) 5)
  ...
  (let ((pos)(str)(strm)(Linefeed)(nL)(L)(LL '((1)))(n 0)(t0)(span)(t1)(t2)(disps))
    ...
    (if (and (> (length L) 4)(numberp (first L)))
      (progn
        ...
        (setq t1 (+ t0 (/ span 2)))
        (setq t2 (- t1 (/ (resource (G-widget "disp2") :length) 2)))
        (change-sensor-selection (string (third L)))
        (setq disps (list "disp1" "disp2" "disp3" "disp4"))
        (dolist (disp disps)
    ...
    (when (G-widget "src" :quiet)(progn
      ...
      (if x 
        (progn
          ...
          (setq span (resource (G-widget "disp2") :length))
          (setq t1 (- t0 (/ span 2)))
          (setq w4 (list "disp1" "disp2" "disp3" "disp4"))
...
(defun scan-max-peak(span)
  (let ((tmax)(tm)(t1)(t2)(names)(ignore)(meg8)(X)(k nil)(k8 nil)(kall nil)(w)(w1)(count 0)(ncount))
    (when (G-widget "meg" :quiet)(progn
      ...
      (link w w1)
      (setq meg8 (list gra-L-temporal gra-R-temporal gra-L-parietal gra-R-parietal gra-L-occipital gra-R-occipital gra-L-frontal gra-R-frontal))
  ...
  (let ((mtx)(x)(tm)(smp)(t0)(bnd)(span)(w))
    (when (G-widget "src" :quiet)(progn
      ...
      (dotimes (i ndip)
        ...
        (data-selection)));;large noise at one ch should be deleted...
      ))
)
...
(defun scan-max-show(span)
  (let ((X)(scale)(x)(names)(wmeg)(wsrc)(wplt)(w (G-widget "disp1")))
    ...
    (set-resource wplt :scales (make-matrix 8 1 x) :offsets (make-matrix 8 1 0.99))
...
(defun select-eegch(chname)
  (if (equal chname "mono")
    (progn
      ...
      (link (G-widget "eeg1")(G-widget "disp3"))))
  (if (equal chname "banana")
    (progn
      ...
      (link (G-widget "fsub")(G-widget "disp3"))))
  ...
  (if (equal chname "misc")
    (progn
      ...
      (link (G-widget "misc")(G-widget "disp4"))))
)

(defun select-megch(chname)
  (if (equal chname "L-temporal")(set-resource (G-widget "meg1") :names gra-L-temporal))
  (if (equal chname "R-temporal")(set-resource (G-widget "meg1") :names gra-R-temporal))
  (if (equal chname "L-parietal")(set-resource (G-widget "meg1") :names gra-L-parietal))
  (if (equal chname "R-parietal")(set-resource (G-widget "meg1") :names gra-R-parietal))
  (if (equal chname "L-occipital")(set-resource (G-widget "meg1") :names gra-L-occipital))
  (if (equal chname "R-occipital")(set-resource (G-widget "meg1") :names gra-R-occipital))
  (if (equal chname "L-frontal")(set-resource (G-widget "meg1") :names gra-L-frontal))
  (if (equal chname "R-frontal")(set-resource (G-widget "meg1") :names gra-R-frontal))
  (if (equal chname "L-temporal-mags")(set-resource (G-widget "meg1") :names mag-L-temporal))
  (if (equal chname "R-temporal-mags")(set-resource (G-widget "meg1") :names mag-R-temporal))
  (if (equal chname "L-parietal-mags")(set-resource (G-widget "meg1") :names mag-L-parietal))
  (if (equal chname "R-parietal-mags")(set-resource (G-widget "meg1") :names mag-R-parietal))
  (if (equal chname "L-occipital-mags")(set-resource (G-widget "meg1") :names mag-L-occipital))
  (if (equal chname "R-occipital-mags")(set-resource (G-widget "meg1") :names mag-R-occipital))
  (if (equal chname "L-frontal-mgas")(set-resource (G-widget "meg1") :names mag-L-frontal))
  (if (equal chname "R-frontal-mgas")(set-resource (G-widget "meg1") :names mag-R-frontal))
  (if (equal chname "menu")(make-menu *display-menu* "MEG chs" "m" 
      :tear-off 
      ...
      '("R-frontal-mags" (select-megch "R-frotanl-mags")))(link (G-widget "meg1")(G-widget "disp2")))
)
...
(defun set204amp()
  (let ((grascale)(nch))
    ...
    (link (G-widget "meg8")(G-widget "disp1"))
    (setq grascale (resource (G-widget "disp2") :scales))
...
(defun set-MEG-EEG-default()
  (let ((x))
    ...
    (set-max-scale (G-widget "disp4") t))
)
...
(defun set-MEG-EEG-default-scale()
  (let ((nch)(xx)(str)(ch))
    ...
    (setq str (get-property (G-widget "disp2") 0 :name))
    (setq ch (read-from-string (string-trim "MEG" str)))
    (if (= 1 (mod ch 10))
      (set-resource (G-widget "disp2") :scales (make-matrix nch 1 my-magnetometer-scale))
      (set-resource (G-widget "disp2") :scales (make-matrix nch 1 my-gradiometer-scale)))
    (setq nch (resource (G-widget "disp3") :channels))
    (set-resource (G-widget "disp3") :scales (make-matrix nch 1 my-eeg-scale)))
)
