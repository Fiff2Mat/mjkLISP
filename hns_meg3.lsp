    ...
    (when (G-widget "src" :quiet)(progn
      ...
      (if x 
        (progn
          ...
          (setq t1 (- t0 (/ span 2)))
          (setq w4 (list "disp1" "disp3" "disp4" "disp5"))
...
(defun select-megch(chname)
  (let ((w1 (G-widget "meg1")))
    (if (equal chname "L-temporal")(set-resource w1 :names gra-L-temporal))
    (if (equal chname "R-temporal")(set-resource w1 :names gra-R-temporal))
    (if (equal chname "L-parietal")(set-resource w1 :names gra-L-parietal))
    (if (equal chname "R-parietal")(set-resource w1 :names gra-R-parietal))
    (if (equal chname "L-occipital")(set-resource w1 :names gra-L-occipital))
    (if (equal chname "R-occipital")(set-resource w1 :names gra-R-occipital))
    (if (equal chname "L-frontal")(set-resource w1 :names gra-L-frontal))
    (if (equal chname "R-frontal")(set-resource w1 :names gra-R-frontal))
    (if (equal chname "L-temporal-mags")(set-resource w1 :names mag-L-temporal))
    (if (equal chname "R-temporal-mags")(set-resource w1 :names mag-R-temporal))
    (if (equal chname "L-parietal-mags")(set-resource w1 :names mag-L-parietal))
    (if (equal chname "R-parietal-mags")(set-resource w1 :names mag-R-parietal))
    (if (equal chname "L-occipital-mags")(set-resource w1 :names mag-L-occipital))
    (if (equal chname "R-occipital-mags")(set-resource w1 :names mag-R-occipital))
    (if (equal chname "L-frontal-mags")(set-resource w1 :names mag-L-frontal))
    (if (equal chname "R-frontal-mags")(set-resource w1 :names mag-R-frontal))
    (if (equal chname "menu")(make-menu *display-menu* "MEG chs" "m" :tear-off 
      '("L-temporal" (progn (select-megch "L-temporal")(link (G-widget "meg1") (G-widget "disp3"))))
      '("R-temporal" (progn (select-megch "R-temporal")(link (G-widget "meg1") (G-widget "disp3"))))
      '("L-parietal" (progn (select-megch "L-parietal")(link (G-widget "meg1") (G-widget "disp3"))))
      '("R-parietal" (progn (select-megch "R-parietal")(link (G-widget "meg1") (G-widget "disp3"))))
      '("L-occipital" (progn (select-megch "L-occipital")(link (G-widget "meg1") (G-widget "disp3"))))
      '("R-occipital" (progn (select-megch "R-occipital")(link (G-widget "meg1") (G-widget "disp3"))))
      '("L-frontal" (progn (select-megch "L-frontal")(link (G-widget "meg1") (G-widget "disp3"))))
      '("R-frontal" (progn (select-megch "R-frontal")(link (G-widget "meg1") (G-widget "disp3"))))
      '("L-temporal-mags" (progn (select-megch "L-temporal-mags")(link (G-widget "meg1") (G-widget "disp3"))))
      '("R-temporal-mags" (progn (select-megch "R-temporal-mags")(link (G-widget "meg1") (G-widget "disp3"))))
      '("L-parietal-mags" (progn (select-megch "L-parietal-mags")(link (G-widget "meg1") (G-widget "disp3"))))
      '("R-parietal-mags" (progn (select-megch "R-parietal-mags")(link (G-widget "meg1") (G-widget "disp3"))))
      '("L-occipital-mags" (progn (select-megch "L-occipital-mags")(link (G-widget "meg1") (G-widget "disp3"))))
      '("R-occipital-mags" (progn (select-megch "R-occipital-mags")(link (G-widget "meg1") (G-widget "disp3"))))
      '("L-frontal-mags" (progn (select-megch "L-frontal-mags")(link (G-widget "meg1") (G-widget "disp3"))))
      '("R-frontal-mags" (progn (select-megch "R-frontal-mags")(link (G-widget "meg1") (G-widget "disp3")))))))
)
...
(defun set306amp()
  (let ((grascale)(nch)(magscale)(w (G-widget "meg8G"))(data)(x))
    ...
    (setq magscale (* magscale 1));thumb's rule
